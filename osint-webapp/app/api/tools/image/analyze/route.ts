/**
 * Image Analyze API Route
 * Handles ExifTool image analysis requests
 */

import { NextRequest, NextResponse } from 'next/server';
import { createClient } from '@/lib/supabase/server';
import { exiftoolInputSchema } from '@/lib/tools/validators/exiftoolValidator';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validationResult = exiftoolInputSchema.safeParse(body);
    ...
    // Log usage
    await logUsage(user.id, 'exiftool', 'analyze', {
